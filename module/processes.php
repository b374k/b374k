...
if(!function_exists('show_processes')){
	function show_processes(){
		...
		if(trim($res)=='') return false;
			...
			$output .= "<tfoot><tr><td><div class='cBoxAll'></div></td><td colspan=".$colspan."><input type='button' class='button' onclick='kill_selected();' value='kill selected' style='margin-right:8px;'><input type='button' class='button' onclick='show_processes();' value='refresh'><span class='psSelected'></span></td></tr></tfoot></table>";
		}
		return $output;
	}
}
